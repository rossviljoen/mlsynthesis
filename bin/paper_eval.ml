...
let run_bench () =
  Sys.command_exn "rm -f ./evaluation/paper/generated_specs/*";
  Sys.command_exn "./evaluation/paper/gen.sh";

  let run size = 
    let filename = "./evaluation/paper/generated_specs/lift_"^ string_of_int size in
